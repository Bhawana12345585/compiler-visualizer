...
static const char *const yytname[] =
{
  ...
  "FLOAT", "ASSIGN", "PLUS", "MINUS", "MUL", "DIV", "SEMI", "$accept",
...
{
       6,     3,    14,    15,    19,     6,   -13,    10,     8,     9,
     -13,   -13,   -13,   -13,    -8,   -13,   -13,    10,    10,    10,
      10,   -13,     5,     5,   -13,   -13
};
...
static const yytype_int8 yytable[] =
{
      17,    18,    19,    20,    21,    22,    23,    24,    25,     1,
       7,     2,     3,    12,    13,    19,    20,     8,     9,    10,
      15,    16,    11
};

static const yytype_int8 yycheck[] =
{
       8,     9,    10,    11,    12,    17,    18,    19,    20,     3,
       7,     5,     6,     3,     4,    10,    11,     3,     3,     0,
      12,    12,     5
};
...
{
       0,     3,     5,     6,    14,    15,    16,     7,     3,     3,
       0,    16,     3,     4,    17,    12,    12,     8,     9,    10,
      11,    12,    17,    17,    17,    17
};
...
#line 40 "parser.y"
          ...
          (yyval.str) = create_node("VarDecl", "int", (yyvsp[-1].str));
      }
#line 1119 "parser.tab.c"
    break;

  case 6: /* stmt: FLOAT ID SEMI  */
#line 44 "parser.y"
                    {
          printf("{\"type\":\"symbol\",\"name\":\"%s\",\"dtype\":\"float\"}\n", (yyvsp[-1].str));
          (yyval.str) = create_node("VarDecl", "float", (yyvsp[-1].str));
      }
...
#line 48 "parser.y"
          ...
          (yyval.str) = create_node("=", (yyvsp[-3].str), (yyvsp[-1].str));
      }
...
#line 57 "parser.y"
                      { (yyval.str) = create_node("+", (yyvsp[-2].str), (yyvsp[0].str)); }
